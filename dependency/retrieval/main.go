...
func getPhpReleases() ([]PhpRelease, error) {
	...
	body, err := webClient.Get("https://raw.githubusercontent.com/paketo/php-dist/main/php-releases/releases.json")
	if err != nil {
	...
	for _, line := range versionLines {
		body, err = webClient.Get(fmt.Sprintf("https://raw.githubusercontent.com/paketo/php-dist/main/php-releases/php-%s.json", line))
		if err != nil {
			return nil, fmt.Errorf("could not hit php.net: %w", err)
		}
...
func getRelease(version string) (PhpRawRelease, error) {
	...
	body, err := webClient.Get(fmt.Sprintf("https://raw.githubusercontent.com/paketo/php-dist/main/php-releases/php-%s.json", searchMajorVersion))
	if err != nil {
